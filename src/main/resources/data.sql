...
-- -----------------------------------------------------
-- Table `xqsrd_cy`.`cy_website_account`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `xqsrd_cy`.`cy_website_account` (
...
-- -----------------------------------------------------
-- Table `xqsrd_cy`.`x_user`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `xqsrd_cy`.`x_user` (
...
-- -----------------------------------------------------
-- Table `xqsrd_cy`.`x_template`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `xqsrd_cy`.`x_template` (
...
-- -----------------------------------------------------
-- Table `xqsrd_cy`.`x_role`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `xqsrd_cy`.`x_role` (
  `xid` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键id',
...
-- -----------------------------------------------------
-- Table `xqsrd_cy`.`x_permission`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `xqsrd_cy`.`x_permission` (
  `xid` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键id',
...
-- -----------------------------------------------------
-- Table `xqsrd_cy`.`x_user_role`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `xqsrd_cy`.`x_user_role` (
  `xid` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键id',
  ...
  `gmt_modified` DATETIME NOT NULL COMMENT '修改时间',
  PRIMARY KEY (`xid`),
  INDEX `fk_role_id_idx` (`x_role_id` ASC),
  INDEX `fk_user_id_idx` (`x_user_id` ASC),
  CONSTRAINT `fk_role_id`
    FOREIGN KEY (`x_role_id`)
    REFERENCES `xqsrd_cy`.`x_role` (`xid`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_user_id`
    FOREIGN KEY (`x_user_id`)
    REFERENCES `xqsrd_cy`.`x_user` (`xid`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION)
ENGINE = InnoDB
COMMENT = '用户角色表';
...
-- -----------------------------------------------------
-- Table `xqsrd_cy`.`x_role_permission`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `xqsrd_cy`.`x_role_permission` (
  `xid` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键id',
  `gmt_create` DATETIME NOT NULL COMMENT '创建时间',
  `gmt_modified` DATETIME NOT NULL COMMENT '修改时间',
  ...
  PRIMARY KEY (`xid`),
  INDEX `fk_role_id2_idx` (`x_role_id` ASC),
  INDEX `fk_permission_id_idx` (`x_permission_id` ASC),
  ...
  CONSTRAINT `fk_permission_id`
    ...
    REFERENCES `xqsrd_cy`.`x_permission` (`xid`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION)
ENGINE = InnoDB
COMMENT = '模板表';
